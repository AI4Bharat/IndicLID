...
def get_dataloaders(X, y, batch_size):
    X, y = X, torch.tensor(y, dtype = torch.long)
...
def evaluate(file_name, lid_model):
    ...
    test_tensor = torch.load(file_name)
...
evaluate( '../corpus/tensor_train.pt', lid_model)
evaluate( '../corpus/tensor_test.pt', lid_model)
evaluate( '../corpus/tensor_valid.pt', lid_model)
evaluate( '../corpus/valid_train_distribution.pt', lid_model)
evaluate( '../corpus/test_dakshina.pt', lid_model)
evaluate( '../corpus/valid_dakshina.pt', lid_model)
evaluate( '../corpus/flores_romanized.pt', lid_model)
evaluate( '../corpus/dakshina_filtered.pt', lid_model)
