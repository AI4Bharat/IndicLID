...
def pca_plot(fasttext_model, words_sampled):
    ...
    # pca_model = TSNE(perplexity=30, n_components=2, init='pca', n_iter=2500, random_state=23)
    # new_values = tsne_model.fit_transform(tokens)
    
    pca_model = PCA(random_state=0)
    new_values = pca_model.fit_transform(tokens)[:,:2]
...
pca_plot(fasttext_model, words_sampled)