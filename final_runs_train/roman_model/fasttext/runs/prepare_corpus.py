...
for lang_code in lang_code_list:
    ...
    if 'v' in valid_data_sources[lang_code]:
        ...
        all_lang_valid_lines_without_dakshina += lines_in_valid
# /nlsasfs/home/ai4bharat/yashkm/yash/indic-lid/preprocess_news_crawl
    if 'nws' in valid_data_sources[lang_code]:
        valid_file_name = '../../../../../../../preprocess_news_crawl/news_tok_norm_romanized_100k_sample_cleaned/' + lang_code + '/'+lang_code + '_romanized.txt'
        f_in_valid = open(valid_file_name, 'r')
        ...
        print("News : len of lines_in_valid : ", len(lines_in_valid))

        lines_in_valid = list( set(lines_in_valid).difference( set(all_lang_test_lines_without_label) ) )


        print("News : len of lines_in_valid after removing test and valid data : ", len(lines_in_valid))
        
        lines_in_valid = [ '__label__'+lang_code_dict[lang_code]+' '+line for line in lines_in_valid ]

        file_lang.write(lang_code_dict[lang_code] + '\t' + 'News' + '\t' + str(len(lines_in_valid)))
        file_lang.write('\n')
    ...
    lines_in_total = lines_in_total[:valid_samples]
...
for lang_code in lang_code_list:
    ...
    if 'nws' in valid_data_sources[lang_code]:
        train_file_name = '../../../../../../../preprocess_news_crawl/news_tok_norm_romanized_100k_sample_cleaned/' + lang_code + '/'+lang_code + '_romanized.txt'
        f_in_train = open(train_file_name, 'r')
...
# Dakshina original roman test
lang_code_list = ['bn', 'gu', 'hi', 'kn', 'ml', 'mr', 'pa', 'ta', 'te', 'ur', 'sd']

all_lang_test_lines_rom = []

file_lang.write('Test Data - Dakshina original roman test\n')
for lang_code in lang_code_list:
...
f_out_test_rom = open('../corpus/test_dakshina_original_roman.txt', 'w')
...
# Dakshina original roman valid

lang_code_list = ['bn', 'gu', 'hi', 'kn', 'ml', 'mr', 'pa', 'ta', 'te', 'ur', 'sd']

all_lang_valid_lines_rom = []

file_lang.write('valid Data - Dakshina original roman valid\n')
for lang_code in lang_code_list:
...
f_out_valid_rom = open('../corpus/valid_dakshina_original_roman.txt', 'w')
...
file_lang.write('Test Data - Dakshina filter roman test\n')
for lang_code in lang_code_list:
...
# Dakshina romanized thorugh IndicXlit
lang_code_list = [
    'bn', 
    'gu', 'hi', 
    'kn', 'ml', 'mr', 
...
file_lang.write('Test Data - Dakshina romanized thorugh IndicXlit\n')
for lang_code in lang_code_list:

    print("lang : ", lang_code_dict[lang_code])

    test_file_name = '../../../../../../../Dakshina/dakshina_romanized/romanized_data/'+lang_code+'_romanized.txt'
    f_in_test = open(test_file_name, 'r')
...
f_out_test_rom = open('../corpus/test_dakshina_indicxlit_romanized.txt', 'w')
...
for lang_code in lang_code_list:
    ...
    test_file_name = '../../../../../../../Other_sources/annotator_ai4bharat_prerocess_test/test_tok_norm_romanized/'+lang_code+'/'+lang_code+'_romanized.txt'
    f_in_test = open(test_file_name, 'r')
...
f_out_test_rom = open('../corpus/test_combine_ai4b_romanized.txt', 'w')
