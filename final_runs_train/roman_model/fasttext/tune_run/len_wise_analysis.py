...
def len_wise_analysis(file_name, step):
    ...
    file_test = open('../corpus/'+file_name+'.txt', 'r')
...
len_wise_analysis('test_combine_dakshina', 5)
len_wise_analysis('valid_combine_dakshina', 5)
len_wise_analysis('test_combine_flores200_romanized', 5)
len_wise_analysis('test_combine_ai4b_romanized', 5)
len_wise_analysis('test_combine_dakshina_romanized', 5)
