...
evaluate('test_dakshina_original_native')
evaluate('valid_dakshina_original_native')
evaluate('test_combine_flores200')
evaluate('valid_combine_flores200')
evaluate('test_combine_AI4Bharat')
evaluate('valid_combine_AI4Bharat')
