...
model = fasttext.load_model('/nlsasfs/home/ai4bharat/yashkm/yash/indic-lid/final_runs_ACL_inference/native_model/fasttext/clean_samples/tune_run/baseline_en_other/result_model_dim_4/model_baseline_roman.bin')
