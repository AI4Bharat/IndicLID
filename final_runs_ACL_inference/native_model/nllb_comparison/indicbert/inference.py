...
model = torch.load('/nlsasfs/home/ai4bharat/yashkm/yash/indic-lid/final_runs_ACL_inference/native_model/finetuning/clean_samples/IndicBERT/unfreeze_layers/result_unfreeze_1/basline_nn_simple.pt')
model.eval()
