...
def measure_inference_time(lines_sampled, threshold):
...
for threshold in thresholds:
    ...
    for _ in range(100):
        ...
        inference_time = measure_inference_time(lines_sampled, threshold)
        inference_time_list.append(inference_time)
    average_inference_time = sum(inference_time_list)/len(inference_time_list)
    file.write('Inference time for threshold ' + str(threshold) + ' : ' + str(average_inference_time) + '\n')
